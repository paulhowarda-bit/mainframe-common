...
#: CICS resources. The three a program NAMES are the first three; the rest are region
#: plumbing that only a CSD defines, and they are here because ``cics-dependencies``
#: emits them into a manifest - a kind this vocabulary does not know is a dependents row
#: with nowhere to attach.
KIND_CICS_TRANSACTION = "cics-transaction"
KIND_TERMINAL_MAP = "terminal-map"
KIND_QUEUE = "queue"
KIND_CICS_PARTITIONSET = "cics-partitionset"
KIND_CICS_LIBRARY = "cics-library"
KIND_CICS_PROFILE = "cics-profile"
KIND_CICS_TRANCLASS = "cics-tranclass"
KIND_CICS_LSRPOOL = "cics-lsrpool"
KIND_CICS_JOURNALMODEL = "cics-journalmodel"
KIND_CICS_CONNECTION = "cics-connection"
KIND_CICS_TERMINAL = "cics-terminal"
KIND_CICS_TYPETERM = "cics-typeterm"
KIND_CICS_URIMAP = "cics-urimap"
KIND_CICS_TCPIPSERVICE = "cics-tcpipservice"
KIND_CICS_PIPELINE = "cics-pipeline"
KIND_CICS_WEBSERVICE = "cics-webservice"
KIND_CICS_DB2ENTRY = "cics-db2entry"
KIND_CICS_JVMSERVER = "cics-jvmserver"
KIND_CICS_BUNDLE = "cics-bundle"
KIND_CICS_PROCESSTYPE = "cics-processtype"
KIND_CICS_DOCTEMPLATE = "cics-doctemplate"
#: JCL members.
KIND_PROC = "proc"
...
MANIFEST_KINDS = frozenset({
    ...
    KIND_CICS_PARTITIONSET, KIND_CICS_LIBRARY, KIND_CICS_PROFILE,
    KIND_CICS_TRANCLASS, KIND_CICS_LSRPOOL, KIND_CICS_JOURNALMODEL,
    KIND_CICS_CONNECTION, KIND_CICS_TERMINAL, KIND_CICS_TYPETERM,
    KIND_CICS_URIMAP, KIND_CICS_TCPIPSERVICE, KIND_CICS_PIPELINE,
    KIND_CICS_WEBSERVICE, KIND_CICS_DB2ENTRY, KIND_CICS_JVMSERVER,
    KIND_CICS_BUNDLE, KIND_CICS_PROCESSTYPE, KIND_CICS_DOCTEMPLATE,
...
HOST_KIND_TO_MANIFEST: Dict[str, str] = {
    ...
    "PARTITIONSET": KIND_CICS_PARTITIONSET,
    "LIBRARY":     KIND_CICS_LIBRARY,
    "CONNECTION":  KIND_CICS_CONNECTION,
    "IPCONN":      KIND_CICS_CONNECTION,
    "TERMINAL":    KIND_CICS_TERMINAL,
    "URIMAP":      KIND_CICS_URIMAP,
    "BUNDLE":      KIND_CICS_BUNDLE,
    "DOCTEMPLATE": KIND_CICS_DOCTEMPLATE,
