...
``mainframe_artifacts`` logs to ``mainframe_artifacts.<module>``, which is not under
...
#: (``mainframe_artifacts.artifact_service`` ...) is a child of it.
PACKAGE_LOGGER = "mainframe_artifacts"
