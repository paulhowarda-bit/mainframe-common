...
from cobol_parser.model import (Action, AlterStmt, EvaluateStmt, HandledStmt,
                               SearchStmt)
from cobol_parser.normalizer import SourceFormat
from cobol_parser.parse_bundle import (FORMAT, VERSION, ParseBundleError,
...
def test_producer_cli_writes_a_bundle_the_reader_accepts(tmp_path):
    from cobol_parser.cli import run
    ...
    from mainframe_artifacts.artifact_service import decode_member
