...
COBOL_PARSER_KOOPA_JAR. Like the Node-backed emitter tests, they SKIP cleanly when
...
from cobol_parser.producers.koopa import (JAR_ENV, KoopaUnavailable, diff_producers,
...
def test_diff_report_agrees_on_a_program_both_parsers_handle(tmp_path):
    ...
    assert report["format"] == "cobol-parser-producer-diff"
    t = report["totals"]
